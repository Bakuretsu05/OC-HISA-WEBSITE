...
const AboutSection = () => {
  return (
    <div className="relative h-[75vh] bg-gray-100">
      <img className="absolute object-fill h-full right-0" src={ganbuPicture} />

      <div className="absolute inset-0 right-0 h-full w-full bg-orange-500 opacity-35"></div>

      <div className="relative z-10 w-2/3 h-full bg-white rounded-r-full shadow-card-shadow p-16 flex items-center">
        <div className="w-4/5">
          <h1 className="text-6xl font-bold mb-6 text-black">OC-HISA</h1>
